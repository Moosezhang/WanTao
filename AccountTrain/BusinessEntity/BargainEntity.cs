...
namespace BusinessEntitys
{
    ...
    /// 砍价表
    /// </summary>
    [EnitityMappingAttribute(TableName = "Train_Bargain")]
    public class BargainEntity : Entity
    {
        /// <summary>
        /// 砍价规则ID
        /// </summary>
        ...
        /// 最多砍多少
        /// </summary>
        [EnitityMappingAttribute(ColumnName = "PrePrice")]
        public decimal PrePrice { get; set; }
        /// <summary>
        /// 最少砍多少
        /// </summary>
        [EnitityMappingAttribute(ColumnName = "NowPrice")]
