...
namespace BusinessEntitys
{
    ...
    /// 点击量记录表
    /// </summary>
    [EnitityMappingAttribute(TableName = "Train_LikeLog")]
    public class LikeLogEntity : Entity
    {
        /// <summary>
        /// 点击Id
        /// </summary>
        [EnitityMappingAttribute(ColumnName = "LikeLogId")]
        public string LikeLogId { get; set; }
